...
/**
 * @file
 * Defines the Drupal\Driver\Remote\Api\AbstractApi class.
 *
...
abstract class AbstractApi implements ApiInterface {
   ...
   *   Number of items per page (Github API?).
   *
   * @return $this
   */
  ...
  /**
   * Build query string parameters for the request.
   *
   * @param \Iterator $params
   *   Parameters to be built.
   *
   * @return string
   *   Built params e.g. param=value&param2=value
   */
  public function buildParams(\Iterator $params) {
    if(!empty($params)) {
