...
namespace Drupal\Driver\Remote\HttpClient;

use Drupal\Driver\Remote\Exception\TwoFactorAuthenticationRequiredException;
use Drupal\Driver\Remote\GuzzleWrapper;
...
use Drupal\Driver\Remote\Exception\ErrorException;
use Drupal\Driver\Remote\HttpClient\Listener\AuthListener;
use Drupal\Driver\Remote\HttpClient\Listener\ErrorListener;
...
class HttpClient implements HttpClientInterface
{
  ...
  public function __construct(array $options = array(), ClientInterface $client = null)
  {
    ...
    $client = $client ?: new \Guzzle\Http\Client($this->options['base_url'], $this->options);
    $this->client  = $client;
